...
const Home = () => {
  ...
  return (
    <>
     <HeroCarousel />
      <main className="mx-auto p-3 h-min-screen">
        {loading ? (
          <div className="text-center text-green-700 font-semibold">Loading products...</div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            ${user ? 'bg-green-600 text-white hover:bg-green-700' : 'bg-gray-300 text-gray-600 cursor-not-allowed'}
          `}
                          >
         ...
         <div className='flex justify-center'><Link to='/products'><button className='bg-green-600 text-white px-6 py-2  rounded-2xl m-6'>See more </button></Link></div>
      </main>
      <AboutUs />
      <ContactUs />
      <Footer />
